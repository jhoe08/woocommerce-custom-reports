( function( $ ){
  ...
  */
  ...
  // Init
	var html = '';
  var dateFrom = $('.data-crureports-from'), dateTo = $('.data-crureports-to'), dateBtn = $('.cru-reports-daterange');
  ...
  from = $( "#cru-reports-daterange-from" )
    ...
    .datepicker("setDate", getFirstDate)
    .on( "change", function() {
  ...
  to = $( "#cru-reports-daterange-to" )
    ...
    .datepicker("setDate", getLastDate)
    .on( "change", function() {
  ...
  var daterange = $('.cru-reports-daterange'), daterangeForm = $('.cru-reports-daterange-form');
  daterange.attr({
